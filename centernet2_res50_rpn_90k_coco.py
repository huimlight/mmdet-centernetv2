...
data_root = '/home/ma-user/work/competition/mmdetection/data/coco/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/home/ma-user/work/competition/mmdetection/data/coco/annotations/instances_train2017.json',
        img_prefix=
        '/home/ma-user/work/competition/mmdetection/data/coco/train2017/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/home/ma-user/work/competition/mmdetection/data/coco/annotations/instances_val2017.json',
        img_prefix=
        '/home/ma-user/work/competition/mmdetection/data/coco/val2017/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
